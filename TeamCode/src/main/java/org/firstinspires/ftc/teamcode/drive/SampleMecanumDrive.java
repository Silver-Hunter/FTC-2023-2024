...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(7.84, 0, 0);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(1.584, 0, 0);

    public static double LATERAL_MULTIPLIER = 1.1030160685;
